...
# from .mirror_worker_warp import MirrorWorkerWarp
...
@ray.remote
class LLMRayActor(MirrorLLMRayActor):
    def __init__(self, *args, bundle_indices: list = None, **kwargs):
    ...
    for i in range(num_engines):
        ...
        vllm_engines.append(
            llm_actor_cls.options(
                ...
                worker_extension_cls="mirror.core.mirror_worker_warp.MirrorWorkerWarp",
...
def batch_vllm_engine_call(engines: List[Any], method_name: str, *args, rank_0_only: bool = True, **kwargs):
    ...
    Args:
        ...
        *args: Additional arguments to pass to the method
        rank_0_only: Whether to only call the method on rank 0
